...
@method_decorator(cache_page(60 * 60 * 6), name='dispatch', key_prefix='best_courses_by_discipline')
...
@method_decorator(cache_page(60 * 60 * 6), name='dispatch', key_prefix='best_courses')
