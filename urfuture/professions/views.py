...
@method_decorator(cache_page(60 * 60 * 12, key_prefix='professions_list'), name='dispatch')
...
@method_decorator(cache_page(60 * 60 * 12, key_prefix='profession_detail'), name='dispatch')
