"""
Django settings for urfuture project.
...
SECRET_KEY = 'django-insecure-syiu00)0(b8m+ldef07to6bb3wy^!7wq25pzov#i-@1d=wz&tf'
...
WSGI_APPLICATION = 'urfuture.wsgi.application'
